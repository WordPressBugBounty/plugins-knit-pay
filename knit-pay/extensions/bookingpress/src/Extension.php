...
class Extension extends AbstractPluginIntegration {
	...
	public function bpa_front_add_payment_gateway() {
		...
		<div class="bpa-front-module--pm-body__item" :class="(appointment_step_form_data.selected_payment_method == 'knit_pay') ? '__bpa-is-selected' : ''" @click="select_payment_method('knit_pay')" v-if="knit_pay_payment != 'false' && knit_pay_payment != ''">
