	...
	<div class='paymentWrapperCard'>
		<div class='paymentContainer' id='payment-first'>
			<div class='topPaymentWrapper'>
				<img src='<?php echo esc_url( $image_path ); ?>back_icon.svg' alt='back button'
					id='backBtn' onclick='cancelOrder()'>
				<h1>Choose a payment option</h1>
				<p>
					Payable Now <span style='font-weight: 800;'><?php echo esc_html( $amount ); ?></span>
				</p>
				<p class='orderid'>Transation Number : <?php echo esc_attr( $transaction_id ); ?></p>
			</div>
			<div class='paymentMethodWrapper'>
				...
				<?php if ( ! $hide_pay_button ) { ?>
					...
					<a href='<?php echo esc_url( add_query_arg( $intent_url_parameters, 'gpay://upi/pay' ) ); ?>' class='methodsWrapper appPayment'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>gpay_icon.svg' alt='gpay'>
							</div>
							<div>
						...
						<div class='rightSide'>
							<img src='<?php echo esc_url( $image_path ); ?>right_icon.svg' alt='button'>
						</div>
					</a>
					<a href='<?php echo esc_url( add_query_arg( $intent_url_parameters, 'phonepe://pay' ) ); ?>' class='methodsWrapper appPayment'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>phonepe.svg' alt='phonepe'>
							</div>
							<div>
					...
					<a href='<?php echo esc_url( add_query_arg( $intent_url_parameters, 'paytmmp://pay' ) ); ?>' class='methodsWrapper appPayment'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>paytm_icon.svg' alt='paytm'>
							</div>
							<div>
					...
					<a href='<?php echo esc_url( add_query_arg( $intent_url_parameters, 'bhim://pay' ) ); ?>' class='methodsWrapper appPayment'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>bhim_icon.svg' alt='paytm'>
							</div>
							<div>
					...
					<a href='<?php echo esc_url( add_query_arg( $intent_url_parameters, 'whatsapp://pay' ) ); ?>' class='methodsWrapper appPayment'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>whatspp_pay.svg' alt='paytm'>
							</div>
							<div>
					...
					<a href='<?php echo esc_url( add_query_arg( $intent_url_parameters, 'upi://pay' ) ); ?>' class='methodsWrapper appPayment'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>upi_icon.svg' alt='UPI'>
							</div>
							<div>
				...
				if ( ! wp_is_mobile() || ! $this->config->hide_mobile_qr ) { // phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.wp_is_mobile_wp_is_mobile
					?>
					<a href='javascript:void(0)' onclick='generateQR(" <?php echo esc_attr( $upi_qr_text ); ?>");' class='methodsWrapper'>
						<div class='leftSide'>
							<div>
								<img src='<?php echo esc_url( $image_path ); ?>qr_icon.svg' alt='qr_icon'>
							</div>
							<div>
		...
		<div class='paymentContainer' id='payment-second' style='display:none'>
			<div class='topPaymentWrapper'>
				<img src='<?php echo esc_url( $image_path ); ?>back_icon.svg' alt='back button' onclick='paynow_back()'>
		...
		<div class='paymentContainer' id='payment-third' style='display:none;'>
			...
			<div class='successIconWrapper'>
				<img src='<?php echo esc_url( $image_path ); ?>unchecked.svg' alt='Success Icon'>
		...
		<div class='paymentFooter'>
			<div class='innerWrapper'>
				...
				<div style='display: flex;gap: 14px;margin:10px;'>
					<img src='<?php echo esc_url( $image_path ); ?>upi.svg' alt='UPI Icon'>
				</div>
			</div>
		</div>
	</div>
...
if ( ! wp_is_mobile() || $hide_pay_button ) { // phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.wp_is_mobile_wp_is_mobile
	?>
	<script>
		generateQR("<?php echo esc_attr( $upi_qr_text ); ?>");
