...
class Webhook extends Gateway {
	...
	/**
	 * Constructs and initializes an PayPal Webhook
	 *
	 * @param int    $config_id Configuration id of PayPal configuration.
	...
	/**
	 * Create or update PayPal webhook for CHECKOUT.ORDER.APPROVED eventsautomatically.
	 * @return null
	 */
